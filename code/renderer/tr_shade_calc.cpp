...
static void AutospriteDeform( void ) {
	...
	if ( tess.numVertexes & 3 ) {
		ri.Warning( "Autosprite shader %s had odd vertex count", tess.shader->name );
	}
	if ( tess.numIndexes != ( tess.numVertexes >> 2 ) * 6 ) {
		ri.Warning( "Autosprite shader %s had odd index count", tess.shader->name );
	}
...
static void Autosprite2Deform( void ) {
	...
	if ( tess.numVertexes & 3 ) {
		ri.Warning( "Autosprite2 shader %s had odd vertex count", tess.shader->name );
	}
	if ( tess.numIndexes != ( tess.numVertexes >> 2 ) * 6 ) {
		ri.Warning( "Autosprite2 shader %s had odd index count", tess.shader->name );
	}
