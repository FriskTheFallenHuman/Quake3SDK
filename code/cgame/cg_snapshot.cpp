...
static snapshot_t * CG_ReadNextSnapshot( void ) {
	...
	while ( cgs.processedSnapshotNum < cg.latestSnapshotNum ) {
		...
		r = cgameLocal->GetSnapshot( cgs.processedSnapshotNum, dest );

		// FIXME: why would cgameLocal->GetSnapshot return a snapshot with the same server time
...
void CG_ProcessSnapshots( void ) {
	...
	cgameLocal->GetCurrentSnapshotNumber( &n, &cg.latestSnapshotTime );
